...
import 'package:projectown/core/services/services.dart';
import 'package:projectown/view/screen/auth/loginScreen.dart';
import 'package:projectown/view/screen/store/addProductScreen.dart';
import 'package:projectown/view/screen/venue/addVenueScreen.dart';
import 'package:projectown/view/screen/venue/AddsectionVenueScreen.dart';
import 'package:projectown/view/screen/venue/selectAvailableTimeScreen.dart';
...
authMiddleWare() {
  if (myServices.sharedPreferences.getInt('auth') == 1) {
    return const LoginScreen();
  } else if (myServices.sharedPreferences.getInt('auth') == 2) {
    //homePage
