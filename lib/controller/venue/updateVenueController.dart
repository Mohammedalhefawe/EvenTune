...
import 'package:projectown/core/constant/color.dart';
import 'package:projectown/linkapi.dart';
import '../../core/class/statusrequest.dart';
import '../../core/functions/handingdatacontroller.dart';
import '../../core/services/services.dart';
import '../../data/datasource/remote/venue/updateVenueData.dart';

class UpdateVenueController extends GetxController {
  ...
  UpdateVenueData updateVenueData = UpdateVenueData(Get.find());
  ...
  void onInit() {
    ...
    print(dataMap);
    venueName = TextEditingController(text: dataMap['name']);
    venueId = dataMap['id'];
    numberPhone =
  ...
  next() async {
    if (formstate!.currentState!.validate()) {
      ...
      update();
      var response = await updateVenueData.updateVenueData(
          AppLink.token,
          venueName!.text != dataMap['name'] ? venueName!.text : null,
