...
import 'package:projectown/view/screen/eventDetails/eventDetalisScreenForInvite.dart';
...
class DeepLinkController {
  ...
  static buildDynamicLinks(String title, String info) async {
    String url = "https://projectown.page.link";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: url,
      link: Uri.parse('$url/$info'),
      androidParameters: const AndroidParameters(
        packageName: "com.example.projectown",
        minimumVersion: 0,
      ),
