...
import 'package:projectown/core/functions/validinput.dart';
import 'package:sizer/sizer.dart';
import '../../../controller/venue/updateVenueController.dart';
...
class UpdateVenueScreen extends StatelessWidget {
  const UpdateVenueScreen({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(UpdateVenueController());
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        leading: IconButton(
      ...
      body: GetBuilder<UpdateVenueController>(builder: (controller) {
